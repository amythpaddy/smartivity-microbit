...
goog.provide('Blockly.Microbit.grove');

goog.require('Blockly.Microbit');


Blockly.Microbit.grove_led = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_stat = this.getFieldValue('STAT');
  Blockly.Microbit.setups_['setup_green_led_'+dropdown_pin] = 'pinMode('+dropdown_pin+', OUTPUT);';
  var code = 'digitalWrite('+dropdown_pin+','+dropdown_stat+');\n'
  return code;
};

Blockly.Microbit.grove_button = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Microbit.setups_['setup_button_'+dropdown_pin] = 'pinMode('+dropdown_pin+', INPUT);';
  var code = 'digitalRead('+dropdown_pin+')';
  return [code, Blockly.Microbit.ORDER_ATOMIC];
};

Blockly.Microbit.grove_rotary_angle = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var code = 'analogRead('+dropdown_pin+')';
  return [code, Blockly.Microbit.ORDER_ATOMIC];
};

Blockly.Microbit.grove_tilt_switch = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Microbit.setups_['setup_tilt_switch_'+dropdown_pin] = 'pinMode('+dropdown_pin+', INPUT);';
  var code = 'digitalRead('+dropdown_pin+')';
  return [code, Blockly.Microbit.ORDER_ATOMIC];
};
...
*/
Blockly.Microbit.grove_piezo_buzzer = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_stat = this.getFieldValue('STAT');
  Blockly.Microbit.setups_['setup_piezo_buzzer_'+dropdown_pin] = 'pinMode('+dropdown_pin+', OUTPUT);';
  var code = 'digitalWrite('+dropdown_pin+','+dropdown_stat+');\n'
  return code;
};

Blockly.Microbit.grove_relay = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_stat = this.getFieldValue('STAT');
  Blockly.Microbit.setups_['setup_relay_'+dropdown_pin] = 'pinMode('+dropdown_pin+', OUTPUT);';
  var code = 'digitalWrite('+dropdown_pin+','+dropdown_stat+');\n'
  return code;
};

Blockly.Microbit.grove_temporature_sensor = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  /*
  a=analogRead(0);
...
Blockly.Microbit.grove_serial_lcd_print = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var text = Blockly.Microbit.valueToCode(this, 'TEXT',
      Blockly.Microbit.ORDER_UNARY_POSTFIX) || '\'\'';
  var text2 = Blockly.Microbit.valueToCode(this, 'TEXT2',
      Blockly.Microbit.ORDER_UNARY_POSTFIX) || '\'\'';
  ...
  Blockly.Microbit.definitions_['define_seriallcd'] = '#include <SerialLCD.h>\n';
  Blockly.Microbit.definitions_['define_softwareserial'] = '#include <SoftwareSerial.h>\n';
  //generate PIN#+1 port
  var NextPIN = _get_next_pin(dropdown_pin);

  Blockly.Microbit.definitions_['var_lcd_'+dropdown_pin] = 'SerialLCD slcd_'+dropdown_pin+'('+dropdown_pin+','+NextPIN+');\n';

  Blockly.Microbit.setups_['setup_lcd_'+dropdown_pin] = 'slcd_'+dropdown_pin+'.begin();\n';
...
Blockly.Microbit.grove_serial_lcd_power = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_stat = this.getFieldValue('STAT');
  ...
  Blockly.Microbit.definitions_['var_lcd'+dropdown_pin] = 'SerialLCD slcd_'+dropdown_pin+'('+dropdown_pin+','+NextPIN+');\n';
...
Blockly.Microbit.grove_serial_lcd_effect = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_stat = this.getFieldValue('STAT');
...
Blockly.Microbit.grove_sound_sensor = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var code = 'analogRead('+dropdown_pin+')';
  return [code, Blockly.Microbit.ORDER_ATOMIC];
};

Blockly.Microbit.grove_pir_motion_sensor = function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
Blockly.Microbit.grove_line_finder = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Microbit.setups_['setup_input_'+dropdown_pin] = 'pinMode('+dropdown_pin+', INPUT);';
  var code = 'digitalRead('+dropdown_pin+')';
  return [code, Blockly.Microbit.ORDER_ATOMIC];
...
Blockly.Microbit.grove_ultrasonic_ranger = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_unit = this.getFieldValue('UNIT');
  Blockly.Microbit.definitions_['define_ultrasonic'] = '#include <Ultrasonic.h>\n';
  Blockly.Microbit.definitions_['var_ultrasonic'+dropdown_pin] = 'Ultrasonic ultrasonic_'+dropdown_pin+'('+dropdown_pin+');';
  var code;
  if(dropdown_unit==="cm"){
...
Blockly.Microbit.grove_motor_shield = function() {
  var dropdown_direction = this.getFieldValue('DIRECTION');
  var speed = 127;//Blockly.Microbit.valueToCode(this, 'SPEED', Blockly.Microbit.ORDER_ATOMIC) || '127';
  Blockly.Microbit.setups_["setup_motor"] = "pinMode(8,OUTPUT);//I1\n"+
  ...
  if(dropdown_direction==="forward"){
    Blockly.Microbit.definitions_['define_forward'] = "void forward()\n"+
"{\n"+
...
"}\n";
    ...
    Blockly.Microbit.definitions_['define_right'] = "void right()\n"+
"{\n"+
     "  analogWrite(9,"+speed+");//input a simulation value to set the speed\n"+
     "  analogWrite(10,"+speed+");\n"+
...
"}\n\n";
    ...
    Blockly.Microbit.definitions_['define_left'] = "void left()\n"+
"{\n"+
     "  analogWrite(9,"+speed+");//input a simulation value to set the speed\n"+
     "  analogWrite(10,"+speed+");\n"+
     "  digitalWrite(13,HIGH);//turn DC Motor B move clockwise\n"+
...
"}\n\n";
    ...
    Blockly.Microbit.definitions_['define_backward'] = "void backward()\n"+
"{\n"+
     "  analogWrite(9,"+speed+");//input a simulation value to set the speed\n"+
     "  analogWrite(10,"+speed+");\n"+
     "  digitalWrite(13,LOW);//turn DC Motor B move anticlockwise\n"+
...
"}\n\n";
    ...
    Blockly.Microbit.definitions_['define_stop'] = "void stop()\n"+
"{\n"+
...
Blockly.Microbit.grove_thumb_joystick =  function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
Blockly.Microbit.grove_rgb_led = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var NextPIN = _get_next_pin(dropdown_pin);

  Blockly.Microbit.setups_['setup_input_'+dropdown_pin] = 'pinMode('+dropdown_pin+', OUTPUT);';
  Blockly.Microbit.setups_['setup_input_'+NextPIN] = 'pinMode('+NextPIN+', OUTPUT);';
  Blockly.Microbit.definitions_['define_uint8'] = "#define uint8 unsigned char";
  Blockly.Microbit.definitions_['define_uint16'] = "#define uint16 unsigned int";
  Blockly.Microbit.definitions_['define_uint32'] = "#define uint32 unsigned long int";
  Blockly.Microbit.definitions_['define_clkproduce_'+dropdown_pin] = "void ClkProduce_"+dropdown_pin+"(void)\n"+
  "{\n"+
  ...
  "  delayMicroseconds(20);\n"+
  "}\n";
  Blockly.Microbit.definitions_['define_send32zero_'+dropdown_pin] = "void Send32Zero_"+dropdown_pin+"(void)\n"+
  "{\n"+
  "  uint8 i;\n"+
  "  for (i=0; i<32; i++)\n"+
  "  {\n"+
  ...
  "  return tmp;\n"+
  "}\n";
  Blockly.Microbit.definitions_['define_datasend_'+dropdown_pin] = "// gray data\n"+
  ...
  "  }\n"+
  "}\n";
  Blockly.Microbit.definitions_['define_datadealwithsend_'+dropdown_pin] = "// data processing\n"+
...
Blockly.Microbit.grove_bluetooth_slave = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var NextPIN = _get_next_pin(dropdown_pin);
  var name = this.getFieldValue('NAME')
  var pincode = this.getFieldValue('PINCODE');
  var statement_receive = Blockly.Microbit.statementToCode(this, "RCV")
  var statement_send = Blockly.Microbit.statementToCode(this, "SNT")
  /* if(pincode.length != 4){
    alert("pincode length should be 4");
  } */
  Blockly.Microbit.definitions_['define_softwareserial'] = '#include <SoftwareSerial.h>\n';
  Blockly.Microbit.definitions_['var_bluetooth_'+dropdown_pin] = 'SoftwareSerial blueToothSerial_'+dropdown_pin+'('+dropdown_pin+','+NextPIN+');\n';

  Blockly.Microbit.setups_['setup_bluetooth_'+dropdown_pin] = 'Serial.begin(9600);\n';
  Blockly.Microbit.setups_['setup_bluetooth_'+dropdown_pin] += '  pinMode('+dropdown_pin+', INPUT);\n';
  Blockly.Microbit.setups_['setup_bluetooth_'+dropdown_pin] += '  pinMode('+NextPIN+', OUTPUT);\n';
  Blockly.Microbit.setups_['setup_bluetooth_'+dropdown_pin] += '  setupBlueToothConnection_'+dropdown_pin+'();\n';

  Blockly.Microbit.definitions_['define_setupBlueToothConnection_'+dropdown_pin] = 'void setupBlueToothConnection_'+dropdown_pin+'()\n'+
  '{\n'+
